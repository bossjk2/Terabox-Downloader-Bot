...
async def handle_message(client: Client, message: Message):
    ...
    if not is_member:
        join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/jk_movie_adda")
    ...
    final_url = f"https://alphaapis.org/terabox/v3/dl?url={url}"
    ...
    caption = (
        ...
        "[ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊᴇᴛ-ᴍɪʀʀᴏʀ ❤️🚀](https://t.me/Jk_movie_adda)"
    )
